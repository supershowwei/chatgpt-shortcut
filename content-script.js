...
const shortcuts = [{
    name: "英翻中",
    content: `將下面的英文一字不漏地翻譯成台灣正體中文，言辭要順暢，產生 3 種版本的翻譯結果，第 2 種版本的翻譯結果是改善自第 1 種版本的翻譯結果，第 3 種翻譯結果是改善自第 2 種翻譯結果，而且只要翻譯就好，並以純文字的方式呈現結果。
...
其中的 {{_CURSOR_}} 在這裡是什麼意思？請列出 10 種可能的翻譯？`,
    replacement: "{{CLIPBOARDTEXT}}",
    useLineGap: false
},
{
